...
class IncorrectTestMessages {
    ...
    static String unexpectedTestedValue(String testedMethodName, String unexpectedTestedValueName, String expectedTestedValueName) {
        return String.format("Ваш тест %s тестирует %s, хотя тест должен тестировать %s.",
            testedMethodName, unexpectedTestedValueName, expectedTestedValueName);
    }
}
