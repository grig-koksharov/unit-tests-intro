...
public class CardTestTest {
    ...
    @Test
    public void should_fail_should_have_negative_balance_when_balance_is_less_than_0_when_buggy_implementation() {
        // Arrange
        givenBuggyImplementation();

        // Act / Assert
        var testedMethodName = "should_have_negative_balance_when_balance_is_less_than_0";
        var unexpectedTestedValue = "карту с позитивным балансом";
        var expectedTestedValue = "карту с негативным балансом";
        assertThatTestFails(testedMethodName, cardTest::should_have_negative_balance_when_balance_is_less_than_0);
    ...
    public void should_pass_should_have_positive_balance_when_balance_is_greater_than_0_when_correct_implementation() {
        ...
        var unexpectedTestedValue = "карту с позитивным балансом";
        var expectedTestedValue = "карту с негативным балансом";
        assertThatTestDoesNotFail(testedMethodName, cardTest::should_have_negative_balance_when_balance_is_less_than_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isNegative();
    }

    @Test
    public void should_fail_should_not_have_negative_balance_when_balance_is_greater_than_0_when_buggy_implementation() {
        // Arrange
        givenBuggyImplementation();

        // Act / Assert
        var testedMethodName = "should_not_have_negative_balance_when_balance_is_greater_than_0";
        var unexpectedTestedValue = "карту с негативным балансом";
        var expectedTestedValue = "карту с позитивным балансом";
        assertThatTestFails(testedMethodName, cardTest::should_not_have_negative_balance_when_balance_is_greater_than_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isPositive();
    }

    @Test
    public void should_pass_should_not_have_negative_balance_when_balance_is_greater_than_0_when_correct_implementation() {
        // Arrange
        givenCorrectImplementation();
        ...
        var unexpectedTestedValue = "карту с негативным балансом";
        var expectedTestedValue = "карту с позитивным балансом";
        assertThatTestDoesNotFail(testedMethodName, cardTest::should_not_have_negative_balance_when_balance_is_greater_than_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isPositive();
    }

    @Test
    public void should_fail_should_not_have_negative_balance_when_balance_is_equal_to_0_when_buggy_implementation() {
        // Arrange
        givenBuggyImplementation();

        // Act / Assert
        var testedMethodName = "should_not_have_negative_balance_when_balance_is_equal_to_0";
        var unexpectedTestedValue = "карту с балансом, неравным нулю";
        var expectedTestedValue = "карту с балансом, равным нулю";
        assertThatTestFails(testedMethodName, cardTest::should_not_have_negative_balance_when_balance_is_equal_to_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isZero();
    }

    @Test
    public void should_pass_should_not_have_negative_balance_when_balance_is_equal_to_0_when_correct_implementation() {
        // Arrange
        givenCorrectImplementation();
        ...
        var unexpectedTestedValue = "карту с балансом, неравным нулю";
        var expectedTestedValue = "карту с балансом, равным нулю";
        assertThatTestDoesNotFail(testedMethodName, cardTest::should_not_have_negative_balance_when_balance_is_equal_to_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isZero();
    }
