...
public class CardTestTest {
    ...
    @Test
    public void should_fail_should_have_zero_balance_when_balance_is_equal_to_0_when_buggy_implementation() {
        // Arrange
        givenBuggyImplementation();

        // Act / Assert
        var testedMethodName = "should_have_zero_balance_when_balance_is_equal_to_0";
        var unexpectedTestedValue = "карту с балансом, неравным нулю";
        var expectedTestedValue = "карту с балансом, равным нулю";
        assertThatTestFails(testedMethodName, cardTest::should_have_zero_balance_when_balance_is_equal_to_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isZero();
    }

    @Test
    public void should_pass_should_have_zero_balance_when_balance_is_equal_to_0_when_correct_implementation() {
        // Arrange
        givenCorrectImplementation();
        ...
        var unexpectedTestedValue = "карту с балансом, неравным нулю";
        var expectedTestedValue = "карту с балансом, равным нулю";
        assertThatTestDoesNotFail(testedMethodName, cardTest::should_have_zero_balance_when_balance_is_equal_to_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isZero();
    }

    @Test
    public void should_fail_should_not_have_zero_balance_when_balance_is_not_equal_to_0_when_buggy_implementation() {
        // Arrange
        givenBuggyImplementation();

        // Act / Assert
        var testedMethodName = "should_not_have_zero_balance_when_balance_is_not_equal_to_0";
        var unexpectedTestedValue = "карту с балансом, равным нулю";
        var expectedTestedValue = "карту с балансом, неравным нулю";
        assertThatTestFails(testedMethodName, cardTest::should_not_have_zero_balance_when_balance_is_not_equal_to_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isNotZero();
    }

    @Test
    public void should_pass_should_not_have_zero_balance_when_balance_is_not_equal_to_0_when_correct_implementation() {
        // Arrange
        givenCorrectImplementation();
        ...
        var unexpectedTestedValue = "карту с балансом, равным нулю";
        var expectedTestedValue = "карту с балансом, неравным нулю";
        assertThatTestDoesNotFail(testedMethodName, cardTest::should_not_have_zero_balance_when_balance_is_not_equal_to_0);
        assertThatCardBalance(testedMethodName, unexpectedTestedValue, expectedTestedValue)
            .isNotZero();
    }
